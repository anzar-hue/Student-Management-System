...
int main(){
    ...
    ifstream inFile("theory_marks.txt");
    if (inFile.is_open()) {
        string header; 
    ...
    while (true){
        ...
        // ==========================================
            ...
            if (activeStudent != nullptr){
                ...
                activeStudent->percentage = (activeStudent->total / 500.0) * 100.0;
                
                cout << "\n=======================================\n";
                cout << "           THEORY MARKSHEET            \n";
                cout << "=======================================\n";
                cout << " Name:    " << activeStudent->name << "\n";
                cout << " Roll No: " << activeStudent->roll_no << " | Sec: " << activeStudent->section << "\n";
                cout << "---------------------------------------\n";
                cout << " Artificial Intelligence : " << activeStudent->Ai_Marks << " / 100\n";
                cout << " OOPM                    : " << activeStudent->OOPM_Marks << " / 100\n";
                cout << " IPS                     : " << activeStudent->IPS_Marks << " / 100\n";
                cout << " Data Structures         : " << activeStudent->DS_Marks << " / 100\n";
                cout << " Theory of Computation   : " << activeStudent->TC_Marks << " / 100\n";
                cout << "---------------------------------------\n";
                cout << " TOTAL SCORE             : " << activeStudent->total << " / 500\n";
        ...
        // ==========================================
            ...
            ofstream outFile("theory_marks.txt");
